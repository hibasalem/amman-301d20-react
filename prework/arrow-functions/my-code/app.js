...
console.log(sumOneLiner(1, 2, 3, 4));
...
// the  refactor 
const newObjectLit = newObjectLit =>({ key1: 'value1',
key2: 'value2',
key3: 'value3',});
...
// the  refactor 
const massageOneLiner= (name) => `Hello, ${name}!`

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(message('Allie'));

console.log(massageOneLiner('Allie'));
...
//  the refactor 
Student.courseNameOneLiner =  ()=>  'This student is enrolled in Code 301.';

// TODO: Uncomment the following line of code to see the output in the browser console
console.log(Student.courseName());

console.log(Student.courseNameOneLiner());
...
// Joe from that line       let joe = new Student('Joe', 'Schmoe', 100);

// 2. What is "this" when joe.scopeArrow() is invoked?
// window , the document itself 

// 3. Explain why "this" is different when an arrow function is used.
//in scopeArrow() when we removed the {} "this" moved in to the globle scoope , but in  joe.scope() it was in the local scoope
